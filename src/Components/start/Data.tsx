...
export const Data = () => {
  return (
    <div className="home_data">
      ...
      <p className="home_description">I'm Joe, someone who likes music and programming, I have some knowledge as a web designer, web developer, game designer, game developer, mobile app developer, desktop app developer/designer, I'm someone creative and I want to learn more and I also do some music and digital art.</p>
